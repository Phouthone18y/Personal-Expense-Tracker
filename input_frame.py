...
class InputFrame(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.add_button.grid(row=3, column=1, padx=5, pady=10, sticky="we")
        self.edit_button = tk.Button(self, text="ບັນທຶກການແກ້ໄຂ", command=self.update_entry, state=tk.DISABLED)
        self.edit_button.grid(row=3, column=2, padx=5, pady=10, sticky="")
    ...
    def update_entry(self):
       ...
       try:
           ...
           if self.data_manager and self.master.table_frame.selected_item:
                ...
                # ลบคอมม่าออกจาก old_amount_str ก่อนแปลงเป็น float
